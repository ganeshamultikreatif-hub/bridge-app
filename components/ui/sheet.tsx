...
function SheetOverlay({
  ...
  return (
    <SheetPrimitive.Overlay
      ...
      className={cn(
        "fixed inset-0 z-50 bg-black/8 duration-300 backdrop-blur-[1px]",
        "dark:bg-black/10",
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          MODAL_PANEL_SURFACE,
          "fixed z-50 flex flex-col gap-4 bg-clip-padding text-sm text-popover-foreground outline-none duration-300",
