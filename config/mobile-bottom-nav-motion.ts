...
/** Extra right gap when the rightmost tab is active. */
export const MOBILE_BOTTOM_NAV_INDICATOR_LAST_EXTRA_RIGHT = 1.5;
...
/** Sliding active tab orb — iOS-style spring slide between items. */
